...
def competition_vote(competition_id):
    ...
    return render_template('competitions/vote.html', competition=competition, competitors=competitors,
                           can_vote=can_vote, has_voted=has_voted, message=message, CURR_TIME=datetime.now())
