...
('Honey Buzz', 'A highly skilled bee known for producing the sweetest honey and exceptional hive management.', '/static/uploads/competitor_images/bees/beecompetitor1.jpg', 2, 'attending', 'Samuel', 45, NOW()),
('Pollen Queen', 'A bee with a knack for collecting the most pollen, ensuring vibrant and healthy blooms.', '/static/uploads/competitor_images/bees/beecompetitor2.jpg', 2, 'attending', 'John_Doe', 46, NOW()),
('Nectar Collector', 'An expert in nectar gathering, contributing to top-quality honey production.', '/static/uploads/competitor_images/bees/beecompetitor3.jpg', 2, 'attending', 'Jane_Smith', 47, NOW()),
('Buzzing Champion', 'A champion in hive communication, known for its complex and effective dance patterns.', '/static/uploads/competitor_images/bees/beecompetitor4.jpg', 2, 'attending', 'Admin', 48, NOW()),
('Golden Wings', 'A bee with impressive flying skills, capable of covering large areas in search of nectar.', '/static/uploads/competitor_images/bees/beecompetitor5.jpg', 2, 'attending', 'Samuel', 49, NOW()),
('Hive Architect', 'Renowned for its ability to build intricate and efficient hive structures.', '/static/uploads/competitor_images/bees/beecompetitor6.jpg', 2, 'attending', 'John_Doe', 50, NOW()),
('Pollen Power', 'A bee known for its strength in transporting large amounts of pollen back to the hive.', '/static/uploads/competitor_images/bees/beecompetitor7.jpg', 2, 'attending', 'Jane_Smith', 45, NOW()),
('Nectar Ninja', 'An agile bee with remarkable speed and precision in nectar collection.', '/static/uploads/competitor_images/bees/beecompetitor8.jpg', 2, 'attending', 'Admin', 46, NOW()),
('Sweet Spinner', 'A bee specializing in spinning honey into a variety of delicious forms.', '/static/uploads/competitor_images/bees/beecompetitor9.jpg', 2, 'attending', 'Samuel', 47, NOW()),
('Autumn Blower', 'An expert at foraging during the autumn season, contributing to a rich and diverse honey flavor.', '/static/uploads/competitor_images/bees/beecompetitor10.jpg', 2, 'attending', 'John_Doe', 48, NOW()),

('Sky Soarer', 'An awe-inspiring bird known for its exceptional flight skills and high-altitude soaring.', '/static/uploads/competitor_images/birds/birdcompetitor1.jpg', 3, 'attending', 'Samuel', 45, NOW()),
('Forest Melody', 'A bird with a beautiful and melodious song, enchanting audiences with its tunes.', '/static/uploads/competitor_images/birds/birdcompetitor2.jpg', 3, 'attending', 'John_Doe', 46, NOW()),
('Feathered Dancer', 'A bird renowned for its graceful and intricate dance moves during courtship.', '/static/uploads/competitor_images/birds/birdcompetitor3.jpg', 3, 'attending', 'Jane_Smith', 47, NOW()),
('Bright Plumage', 'A bird with strikingly colorful feathers, making it a visual standout in the competition.', '/static/uploads/competitor_images/birds/birdcompetitor4.jpg', 3, 'attending', 'Admin', 48, NOW()),
('Mountain Flyer', 'An expert in navigating rugged mountain terrains with agility and precision.', '/static/uploads/competitor_images/birds/birdcompetitor5.jpg', 3, 'attending', 'Samuel', 49, NOW()),
('Jungle Chatter', 'Known for its diverse and complex vocalizations, a true performer in the avian world.', '/static/uploads/competitor_images/birds/birdcompetitor6.jpg', 3, 'attending', 'John_Doe', 50, NOW()),
('Ocean Glider', 'A bird with exceptional skills in gliding over the ocean, known for its effortless flight.', '/static/uploads/competitor_images/birds/birdcompetitor7.jpg', 3, 'attending', 'Jane_Smith', 45, NOW()),
('Desert Nomad', 'Adapted to harsh desert conditions, known for its resilience and unique survival skills.', '/static/uploads/competitor_images/birds/birdcompetitor8.jpg', 3, 'attending', 'Admin', 46, NOW()),
('Swamp Specter', 'A bird with mysterious and elusive behavior, often seen in the quiet and hidden corners of swamps.', '/static/uploads/competitor_images/birds/birdcompetitor9.jpg', 3, 'attending', 'Samuel', 47, NOW()),
('Highland Herald', 'A bird from the highlands, known for its strong and clear calls that echo across the mountains.', '/static/uploads/competitor_images/birds/birdcompetitor10.jpg', 3, 'attending', 'John_Doe', 48, NOW()),

('Majestic Stag', 'A regal stag with impressive antlers, known for its commanding presence and grace.', '/static/uploads/competitor_images/deers/deercompetitor1.jpg', 4, 'attending', 'Samuel', 45, NOW()),
('Forest Guardian', 'A strong and protective deer, revered for its role in maintaining the balance of the forest.', '/static/uploads/competitor_images/deers/deercompetitor2.jpg', 4, 'attending', 'John_Doe', 46, NOW()),
('Gentle Doe', 'A graceful doe with a gentle demeanor, admired for its beauty and elegance in the wild.', '/static/uploads/competitor_images/deers/deercompetitor3.jpg', 4, 'attending', 'Jane_Smith', 47, NOW()),
('Winter Walker', 'A deer adapted to cold climates, known for its endurance and adaptability in snowy terrains.', '/static/uploads/competitor_images/deers/deercompetitor4.jpg', 4, 'attending', 'Admin', 48, NOW()),
('Autumn Roamer', 'A deer that thrives in autumn, with a striking coat that blends seamlessly with the fall foliage.', '/static/uploads/competitor_images/deers/deercompetitor5.jpg', 4, 'attending', 'Samuel', 49, NOW()),
('Mountain Prince', 'A majestic deer from the highlands, known for its impressive antler spread and robust physique.', '/static/uploads/competitor_images/deers/deercompetitor6.jpg', 4, 'attending', 'John_Doe', 50, NOW()),
('Meadow Dancer', 'A lively deer that is known for its playful movements and elegance while grazing in meadows.', '/static/uploads/competitor_images/deers/deercompetitor7.jpg', 4, 'attending', 'Jane_Smith', 45, NOW()),
('River Watcher', 'A deer that is often seen near rivers, known for its keen awareness and agility around water.', '/static/uploads/competitor_images/deers/deercompetitor8.jpg', 4, 'attending', 'Admin', 46, NOW()),
('Sunset Strider', 'A deer with a distinctive appearance, often spotted at dusk with a stunning silhouette against the setting sun.', '/static/uploads/competitor_images/deers/deercompetitor9.jpg', 4, 'attending', 'Samuel', 47, NOW()),
('Evergreen Sentinel', 'A deer that stands out in evergreen forests, known for its resilience and enduring presence throughout the year.', '/static/uploads/competitor_images/deers/deercompetitor10.jpg', 4, 'attending', 'John_Doe', 48, NOW());
...
VALUES 
    ...
    (2, 1, 1, 'valid', '192.168.1.1'),
    (2, 1, 2, 'valid', '192.168.1.2'),
    (2, 1, 3, 'valid', '192.168.1.3'),
    (2, 1, 4, 'valid', '192.168.1.4'),
    (2, 1, 5, 'valid', '192.168.1.5'),
    (2, 1, 6, 'valid', '192.168.1.6'),
    (2, 1, 7, 'valid', '192.168.1.7'),
    (2, 1, 8, 'valid', '192.168.1.8'),
    (2, 1, 9, 'valid', '192.168.1.9'),
    (2, 1, 10, 'valid', '192.168.1.10'),
    ...
    (3, 1, 1, 'valid', '192.168.1.1'),
    (3, 1, 2, 'valid', '192.168.1.2'),
    (3, 1, 3, 'valid', '192.168.1.3'),
    (3, 1, 4, 'valid', '192.168.1.4'),
    (3, 1, 5, 'valid', '192.168.1.5'),
    (3, 1, 6, 'valid', '192.168.1.6'),
    (3, 1, 7, 'valid', '192.168.1.7'),
    (3, 1, 8, 'valid', '192.168.1.8'),
    (3, 1, 9, 'valid', '192.168.1.9'),
    (3, 1, 10, 'valid', '192.168.1.10'),
